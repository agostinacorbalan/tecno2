...
void dibujarMenu () {
  ...
  if (pantalla == 0) {
    ...
    textFont(texto);
    dibujarBoton(width/2, height/9, width/2, height/2 - width/10, width/30, "Play", 0);
    dibujarBoton(width/2, height/9, width/2, height/2, width/30, "Instrucciones", 1);
    dibujarBoton(width/2, height/9, width/2, height /2 + width/10, width/30, "Creditos", 2);
    textSize(width/12);
    textFont(titulo);
  ...
  if (pantalla == 1) {
    ...
    textFont(texto);
    dibujarBoton(width/5, height/12, width/12, height/18, width/60, "Volver a Menu", 3);
  }
  if (pantalla ==2) {
