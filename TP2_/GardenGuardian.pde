...
void perdio() {
  ...
  textFont(titulo);
  pantallaDibujar(#ffffff, width/10, "PERDISTE", "La loca de la escoba rompio toda la huertita :(" );
}

void gano() {
  dibujarPantallaGanar();
  textFont(titulo);
  pantallaDibujar(#000000, width/10, "GANASTE", "Mataste a la loca de la escoba" );
}
